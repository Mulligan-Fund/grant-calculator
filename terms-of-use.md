...
To understand how we collect, use and safeguard the information you may provide to us via the Services, including personal information, please review PEAK’s Privacy Note. [Insert Hyperlink.]
...
You may include a link to the PEAK website on one or more other websites, social media accounts, or other online services operated by you, provided that you do not violate any of the below “RESTRICTIONS ON USE” [Insert internal hyperlink to section.] or incorporate or include any Malicious Code (as defined below) and/or content that is disparaging, abusive, harassing, illegal, discriminatory, fraudulent, or violates the intellectual property, privacy, or other rights of PEAK or any person or entity. This limited license expressly prohibits any activity that may confuse, misdirect, or misrepresent with respect to sponsorship or affiliation.
...
PEAK may use Your Data in aggregated or de-identified form for its own business purposes, and such aggregated or de-identified data shall no longer be deemed Your Data.
...
GOVERNING LAW; ARBITRATION; CLASS ACTION WAIVER; JURY TRIAL WAIVER 
